...
//file_put_contents('gpt-math-vFP32.bin', GPT_Pack::encode($weights, GPT_Pack::Q_FP32));

else:
    //require 'param.php';
    $state_dict = GPT_pack::decode(file_get_contents('gpt-math-vFP32.bin'));
...
$temperature = 0.1; # 0.6
echo "\n--- inference ---\n";
for ($sample_idx = 0; $sample_idx < 11; $sample_idx++) {
    $keys = array_fill(0, $n_layer, []);
    $values = array_fill(0, $n_layer, []);
    $token_id = $BOS;
    echo "sample " . ($sample_idx + 1) . ": ";
$sss='';    
